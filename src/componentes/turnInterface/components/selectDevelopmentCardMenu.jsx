...
export default function SelectDevelopmentCardMenu() {
  const { setTurnStateToMoveTheThief, setTurnStateToRoadBuilderCardFirstRoad, setTurnStateToYearOfPlenty, setTurnStateToIdle } = useContext(TurnStateContext);
  return (
    <>
    <h3>Select what develoment card you would like to player.</h3>
      ...
      <button onClick={() => setTurnStateToYearOfPlenty()}>Year of Plenty</button>
