    ...
    <>
      ...
      <div className={"tradeWithPlayerMenu"}>
        <div className="resourceHolder">
          {oneLumberIcon}
          {props.giveResources.Lumber > 0 ? <div className="tradeAmount negativeNumber">{props.giveResources.Lumber}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneBrickIcon}
          {props.giveResources.Brick > 0 ? <div className="tradeAmount negativeNumber">{props.giveResources.Brick}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneWoolIcon}
          {props.giveResources.Wool > 0 ? <div className="tradeAmount negativeNumber">{props.giveResources.Wool}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneGrainIcon}
          {props.giveResources.Grain > 0 ? <div className="tradeAmount negativeNumber">{props.giveResources.Grain}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneOreIcon}
          {props.giveResources.Ore > 0 ? <div className="tradeAmount negativeNumber">{props.giveResources.Ore}</div> : <div className="tradeAmount">0</div>}
      ...
      <div className={"tradeWithPlayerMenu"}>
        <div className="resourceHolder">
          {oneLumberIcon}
          {props.recieveResources.Lumber > 0 ? <div className="tradeAmount positiveNumber">{props.recieveResources.Lumber}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneBrickIcon}
          {props.recieveResources.Brick > 0 ? <div className="tradeAmount positiveNumber">{props.recieveResources.Brick}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneWoolIcon}
          {props.recieveResources.Wool > 0 ? <div className="tradeAmount positiveNumber">{props.recieveResources.Wool}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneGrainIcon}
          {props.recieveResources.Grain > 0 ? <div className="tradeAmount positiveNumber">{props.recieveResources.Grain}</div> : <div className="tradeAmount">0</div>}
        ...
        <div className="resourceHolder">
          {oneOreIcon}
          {props.recieveResources.Ore > 0 ? <div className="tradeAmount positiveNumber">{props.recieveResources.Ore}</div> : <div className="tradeAmount">0</div>}
