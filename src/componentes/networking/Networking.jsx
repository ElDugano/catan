...
//Likely, we will want to delete all of this and just call in the options from NetworkingClientSetup and hostSetup.
//We will likely want to have it so the game keeps this running, and this will effectively be handeling keeping the
//conn.on('open', function) open and running the whole time.
//We will also need to handle the cases of if a player disconnects, likely as well.
