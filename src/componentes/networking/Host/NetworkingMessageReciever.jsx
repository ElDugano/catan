    ...
    if (recievedMessages != null) {
      ...
      console.log("This was sent from Player: "+recievedMessagesPlayer)
        if (typeof recievedMessages === 'object'){
          ...
          "numberOfPlayers"           in recievedMessages && setNumberOfPlayers(recievedMessages.numberOfPlayers);
          ...
          "cancelTrade"               in recievedMessages && props.cancelTrade(recievedMessages.cancelTrade);
