...
export default function BoardDisplay({landTiles, landTileNumbers, tileCornerNodes, tileNodeClickFunction, thiefLocation}) {
  return (
    <>
      <svg className="hex-grid" viewBox="0 0 420 370">
        <Tiles landTiles={landTiles} />
        <TileNumbers landTileNumbers={landTileNumbers} />
        <CornerNodes tileCornerNodes={tileCornerNodes} tileNodeClickFunction={tileNodeClickFunction} />
